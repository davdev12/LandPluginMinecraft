...
public class LandUpgradeHandler {
    ...
    public void upgradeLand(Player player, String landName) {
        ...
        land.setPos1(new Location(pos1.getWorld(), expandedMinX, pos1.getBlockY(), expandedMinZ));
        land.setPos2(new Location(pos2.getWorld(), expandedMaxX, pos2.getBlockY(), expandedMaxZ));
